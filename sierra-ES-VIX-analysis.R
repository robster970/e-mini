...
cleanData = subset(mergeddata, select = c(4,9,10,11,12,13))
...
cleanData$Stop.esdata <- cleanData$ATR.esdata * (1+atrStopFactor)
cleanData$Dir.esdata <- cleanData$Last.esdata - cleanData$Open.esdata
